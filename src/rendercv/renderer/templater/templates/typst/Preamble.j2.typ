...
#show: rendercv.with(
  ...
  sections-space-between-text-entries: {{ design.sections.space_between_text_entries }},
  ...
  entries-highlights-bullet: {% if design.entries.highlights.bullet == "●" %} text(13pt, [•], baseline: -0.5pt) {% else %} "{{ design.entries.highlights.bullet }}" {% endif %},
  entries-highlights-nested-bullet: {% if design.entries.highlights.nested_bullet == "●" %} text(13pt, [•], baseline: -0.5pt) {% else %} "{{ design.entries.highlights.bullet }}" {% endif %},
