...
def render_pdf_to_file(rendercv_model: RenderCVModel, typst_path: pathlib.Path) -> None:
...
def render_png_to_file(rendercv_model: RenderCVModel, typst_path: pathlib.Path) -> None:
