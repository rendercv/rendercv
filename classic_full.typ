...
#show: rendercv.with(
  ...
  section-titles-space-below: 0cm,
  sections-allow-page-break: true,
  sections-space-between-text-based-entries: 0cm,
...
#connections(
  ...
  [#link(
    "https://stackoverflow.com/users/12323/johndoe",
    icon: false,
    if-underline: false,
    if-color: false,
  )[stackoverflow.com\/users\/12323\/johndoe]],
  [#link("https://gitlab.com/johndoe", icon: false, if-underline: false, if-color: false)[gitlab.com\/johndoe]],
  [#link(
    "https://researchgate.net/profile/johndoe",
    icon: false,
    if-underline: false,
    if-color: false,
  )[researchgate.net\/profile\/johndoe]],
