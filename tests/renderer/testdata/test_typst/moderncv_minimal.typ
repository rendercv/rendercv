...
#show: rendercv.with(
  ...
  header-name-font-family: "Fontin",
  header-name-font-size: 25pt,
  header-name-bold: false,
  header-small-caps-for-name: false,
  header-photo-width: 3.5cm,
  header-connections-font-family: "Fontin",
  ...
  section-titles-font-family: "Fontin",
  section-titles-font-size: 1.4em,
  section-titles-bold: false,
  section-titles-small-caps: false,
  section-titles-line-thickness: 0.15cm,
  section-titles-vertical-space-above: 0.55cm,
  section-titles-vertical-space-below: 0.3cm,
  entries-date-and-location-width: 4.15cm,
  entries-left-and-right-margin: 0cm,
  entries-horizontal-space-between-columns: 0.4cm,
  ...
  highlights-left-margin: 0cm,
  highlights-vertical-space-between-highlights: 0.19cm,
  highlights-horizontal-space-between-bullet-and-highlights: 0.3em,
